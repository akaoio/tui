...
const tui = new TUI({ title: 'ProgressBar Visual Test' });

console.log('TUI_COMPONENT_ACTIVE');
console.log(tui.createHeader());
tui.showInfo('Testing ProgressBar component');

// Display component info
const items = [
    { label: 'Component', value: 'ProgressBar', status: 'info' },
...
tui.showSuccess('ProgressBar rendered successfully');
