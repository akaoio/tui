...
const tui = new TUI({ title: 'Radio Visual Test' });

console.log('TUI_COMPONENT_ACTIVE');
console.log(tui.createHeader());
tui.showInfo('Testing Radio component');

// Display component info
const items = [
    { label: 'Component', value: 'Radio', status: 'info' },
