...
const tui = new TUI({ title: 'JsonEditor Visual Test' });

console.log('TUI_COMPONENT_ACTIVE');
console.log(tui.createHeader());
tui.showInfo('Testing JsonEditor component');

// Display component info
const items = [
    { label: 'Component', value: 'JsonEditor', status: 'info' },
